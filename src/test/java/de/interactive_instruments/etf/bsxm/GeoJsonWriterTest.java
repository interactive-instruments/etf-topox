...
public class GeoJsonWriterTest {
	...
	public void testWriteFeatureFile() throws IOException {
		...
		writer.addCoordinates("9 9 2 2 1 1".getBytes());
		writer.addCoordinates("1 1 123 4123".getBytes());
		writer.addCoordinates("1 1 2 2".getBytes());
		writer.addCoordinates("2 2 9 9".getBytes());
	...
	public void testWriteFileMultiple() throws IOException {
		...
		writer.addCoordinates("11414 2134214 431 4123".getBytes());
		writer.nextInterior();
		writer.addCoordinatesInterior("11414 2134214 431 4123".getBytes());
